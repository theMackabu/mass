...
export const Button = ({ color, outline, plain, className, children, ...props }: ButtonProps) => {
  const classes = cn(
    className,
    styles.base,
  ...
  <Headless.Button {...props} className={cn(classes, 'cursor-pointer')}>
    <TouchTarget>{children}</TouchTarget>
  </Headless.Button>;
};

export const TouchTarget = ({ children }: Children) => (
  <Fragment>
    <span
